...
class MediaDownloaderPro(QMainWindow):
    ...
    def __init__(self):
        ...
        self.download_directory = os.path.join("C:\\Users\\Usuario", "baixador de qualquer coisa")
        ...
        self.directory_label = QLabel(self.download_directory)
    ...
    def choose_directory(self):
        directory = QFileDialog.getExistingDirectory(
            ...
            self.download_directory,  # Começa com o diretório padrão
